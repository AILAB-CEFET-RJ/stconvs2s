...
class STConvLSTM(nn.Module):
    def __init__(self, input_size, dropout_rate, layer_size=3, kernel_size=5, hidden_dim=32, upsample=False):
        ...
        self.upsample_conv = nn.ConvTranspose3d(hidden_dim, hidden_dim, kernel_size=[kernel_size,1,1],
                                                stride=[3,1,1], padding=[1,0,0])
        self.conv_layer = nn.Conv3d(in_channels=hidden_dim, out_channels=1, kernel_size=(1,1,1), padding=0)
    ...
    def forward(self, input_):
        ...
        if (self.upsample):
            output_size = torch.randn(input_.shape[0],input_.shape[1], input_.shape[2] + 10, 
...
#--------------------------------------------------------
# Credits to the code below: https://github.com/AlexMa011
# Updated by me
#--------------------------------------------------------
...
class ConvLSTM(nn.Module):
    ...
    def forward(self, input_tensor, hidden_state=None):
        ...
        sequence_size = input_tensor.size(2)   
